local intro_logo = {
    ...
    "`7MM6666Mq.`7MMF' `7MMF' `YMM'  `7MMF'",
    "  MM   `MM.  MM     MM   .M'      MM",
    "  MM   ,M9   MM     MM .M'        MM",
    "  MMmmdM9    MM     MMMMM.        MM",
    "  MM         MM     MM  VMA       MM",
    "  MM         MM     MM   `MM.     MM",
    ".JMML.     .JMML. .JMML.   MMb. .JMML.",
}

local PLUGIN_NAME = "Thanks for checking out piki!"
...
local function draw_minintro(buf, logo_width, logo_height)
	...
	local start_col = math.floor(((screen_width - logo_width) / 2) + 6)
